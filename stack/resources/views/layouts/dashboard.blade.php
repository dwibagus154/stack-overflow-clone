...
<head>
    ...
    <!-- DEMO CHARTS -->
    <link rel="stylesheet" href="{{ asset('dashboard/public/demo/chartist.css') }}">
    <link rel="stylesheet" href="{{ asset('dashboard/public/demo/chartist-plugin-tooltip.css') }}">
...
<body class="has-sidebar has-fixed-sidebar-and-header">
        ...
        <aside id="sidebar" class="js-custom-scroll side-nav">
            <ul id="sideNav" class="side-nav-menu side-nav-menu-top-level mb-0">
                ...
                <li class="side-nav-menu-item">
                    <a class="side-nav-menu-link media align-items-center" href="{{ url('./question') }}">
                        <span class="side-nav-menu-icon d-flex mr-3">
                            <i class="gd-file"></i>
                        </span>
                ...
                <!-- Settings -->
                <li class="side-nav-menu-item">
                    <a class="nav-link disabled media align-items-center" href="settings.html">
                        <span class="side-nav-menu-icon d-flex mr-3">
    ...
    <script src="dashboard/public/graindashboard/js/graindashboard.js"></script>
    <script src="dashboard/public/graindashboard/js/graindashboard.vendor.js"></script>

    <!-- DEMO CHARTS -->
    <script src="{{ asset('dashboard/public/demo/resizeSensor.js') }}"></script>
    <script src="{{ asset('dashboard/public/demo/chartist.js') }}"></script>
    <script src="{{ asset('dashboard/public/demo/chartist-plugin-tooltip.js') }}"></script>
    <script src="{{ asset('dashboard/public/demo/gd.chartist-area.js') }}"></script>
    <script src="{{ asset('dashboard/public/demo/gd.chartist-bar.js') }}"></script>
    <script src="{{ asset('dashboardpublic/demo/gd.chartist-donut.js') }}"></script>
    <script>
